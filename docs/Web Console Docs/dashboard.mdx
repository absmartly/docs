...
how to create one in the [creating an experiment](docs/Web%20Console%20Docs/creating-an-experiment)
docs.

<Image img={require("../../static/img/dashboard.png")} />

---

## Experiment Dashboard

To enter the experiment dashboard, just click on one of your experiments.
...
<Image img={require("../../static/img/experiment_main_info.png")} />
...
<Image img={require("../../static/img/impact_on_main_metrics.png")} />
...
<Image img={require("../../static/img/participants.png")} />
...
<Image img={require("../../static/img/goal_summary.png")} />
...
metrics have been affected by the experiment.
...
<Image img={require("../../static/img/segments.png")} />
...
Dashboard Settings docs for information on creating segments, or checkout the
[Attributes](docs/SDK%20Documentation/Advanced/context-attributes.mdx) section
of the SDK docs for information on how to use them in your code.
...
:::success Sample Size Reached
The "Sample Size Reached" warning is green and tells you that your experiment
has been exposed to enough participants for you to make a decision about it.
:::

:::info Code Cleanup Needed
...
too long ago and the api is still receiving exposure calls from this
experiment, this flag will come up.
:::

:::caution Audience Mistmatch
