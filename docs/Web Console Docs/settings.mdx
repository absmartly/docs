...
```json
{
  ...
  "changes": {
    ...
    "applications": [1, 2],
    "other": "test other updated",
    "prediction": "test prediction updated",
    "percentages": "50/50",
    "percentage_of_traffic": 95,
    "implementation_details": "test implementation details updated",
    "hypothesis": "test hypothesis updated",
    "action_points": "test action points updated",
    "owners": [1, 19],
    "secondary_metrics": [
      {
        "goal_id": 1,
