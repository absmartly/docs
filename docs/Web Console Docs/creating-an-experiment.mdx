...
Metrics are inherantly linked to your company's [goals](docs/Web%20Console%20Docs/settings.mdx#goals).
Your primary metric is the statistic used to make a decision about your
experiment.
...
them in the [experiment dashboard](docs/Web%20Console%20Docs/dashboard.mdx#impact-on-main-metrics).
...
<Image img={require("../../static/img/targeting_audience.png")} />
