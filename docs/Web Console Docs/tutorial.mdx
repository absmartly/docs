...
Here you can specify what is an outlier for this metric and which strategy
should be used to cap the values.
...
<table>
  ...
  <tbody>
    <tr>
      <th>Uncapped</th>
      <td>No outlier treatment is performed</td>
    </tr>
    <tr>
      <th>99th Percentile</th>
      <td>Cap each value to the 99th percentile of all seen values</td>
    </tr>
    <tr>
