...
<Image img="experiment-dashboard/health-checks-0-6.png" alt="Health Check on the experiment dashboard" maxWidh="40rem" />
...
<Image img="experiment-dashboard/health-checks-panel.png" alt="Health Check Panel" maxWidh="15rem" />
