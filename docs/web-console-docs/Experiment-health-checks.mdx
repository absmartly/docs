...
<Image img="experiment-dashboard/health-checks-0-6.png" alt="Health Check on the experiment dashboard" maxWidth="40rem" />

 If any issue is detected with your experiment, an alert would be triggered and a notification shown on the dashboard.

<Image img="experiment-dashboard/health-checks-audience-mismatch.png" alt="Audience mismatch warning" maxWidth="40rem" />

<Image img="experiment-dashboard/health-checks-panel.png" alt="Health Check Panel" maxWidth="15rem" />

--- 
## What Health Checks does ABsmartly perform?
