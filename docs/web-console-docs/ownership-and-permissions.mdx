...
<Image img="ownership-model/team-structure.png" alt="Team structure" maxWidh="50rem" />
...
<Image img="ownership-model/team-roles.png" alt="Team roles" maxWidh="20rem" />
<Image img="ownership-model/team-members-with-roles.png" alt="Team members with roles" maxWidh="50rem" />

:::note
**Note**: If team members are not assigned any of those roles, they will be team members but won't be able to view or interact with any of the team's assets.
:::
...
:::info
**Action item**: Make sure to add all platform users to their respective team and assign them the correct role so they can interact with the team's assets.
...
We are curious to hear what use cases you have so we can better cater for your specific needs.
:::
...
<Image img="ownership-model/invite-user.png" alt="Invite user" maxWidh="20rem" />
<Image img="ownership-model/shared-asset.png" alt="Shared asset" maxWidh="20rem" />
