...
because of early worrying negative signals or any other reason. Read our [When to abort an experiment?](Aborting-experiments) guide to understand more about aborting experiments.
