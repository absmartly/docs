...
[treatment variables](/docs/APIs-and-SDKs/SDK-Documentation/basic-usage#treatment-variables) in the SDK Documentation for more information.
...
These audience parameters can then be passed to the SDK in your code using [context attributes](/docs/APIs-and-SDKs/SDK-Documentation/Advanced/context-attributes.mdx).
#### Audience Enforced
...
1. **Who to exclude** — A set of conditions that identify the visitors to exclude, based on [context attributes](/docs/APIs-and-SDKs/SDK-Documentation/Advanced/context-attributes.mdx) (e.g. `user_type = internal`, `email ends_with @yourcompany.com`).
...
See the [SDK documentation](/docs/APIs-and-SDKs/SDK-Documentation/basic-usage) for details.
:::
