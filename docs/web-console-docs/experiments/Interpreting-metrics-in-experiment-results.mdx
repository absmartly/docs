...
- **Impact**: The percentage change in the metric compared to the baseline. This is a GST adjusted value. For example, +1.74% with a confidence interval going from -1.88% to +5.49%.
