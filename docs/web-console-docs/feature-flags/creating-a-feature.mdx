...
ABsmartly platform, without having to go through the entire experimentation
...
have screenshots added to it and can be assigned some [variant variables](/docs/APIs-and-SDKs/SDK-Documentation/running-your-first-experiment#step-2-use-variables-for-flexible-experiments).
