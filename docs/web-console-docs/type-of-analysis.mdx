...
[Group Sequential Testing](https://absmartly.com/engine) is an adaptive analysis method that allows for interim analyses at various points during the experiment. At ABsmartly you can decide how often or how many interim analysis you want. Unlike Fixed Horizon Testing, this approach provides the flexibility to stop the experiments early for efficacy or for futility.
...
// TODO Add information about 1-sided and 2-sided analysis
