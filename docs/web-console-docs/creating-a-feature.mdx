...
<Image img="feature_flag_basics.png" alt="Basics step of the Feature Flag creation form." />
...
<Image img="feature_flag_variants.png" alt="The Variants step of the Feature Flag creation form." />
...
<Image img="feature_flag_audiences.png" alt="The Audiences step of the Feature Flag creation form." />
...
<Image img="feature_flag_metrics.png" alt="The Metrics step of the Feature Flag creation form." />
...
<Image img="feature_flag_metadata.png" alt="The Metadata step of the Feature Flag creation form." />
...
<Image img="feature_flag_review.png" alt="The Review step of the Feature Flag creation form." />
