...
giving experimenter a more accurate view of the actual business impact of their changes.
...
Current goal key property
The identifier on the current goal (e.g., order_number).
...
Foreign goal
The goal event representing the refund (e.g., refund).
...
This relation ensures that metrics involving values such as revenue or GMV reflect the impact of refunds accurately.
...
Foreign goal key property
The matching identifier on the replacement event.
