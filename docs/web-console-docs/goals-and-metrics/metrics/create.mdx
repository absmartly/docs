...
:::info
Outliers capping is done using the full experiment population, so all variants have the same capping limits.
:::
...
- **Duplicated foreign goal aggregation**
How the value of the foreign goal achievement will be aggregated
