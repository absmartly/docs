...
- Pre-experiment data is automatically collected during the defined pre-period
...
- [Understanding Statistical Power in A/B Testing](/docs/web-console-docs/experiments/statistical-power)
- [Choosing the Right Metrics](/docs/web-console-docs/goals-and-metrics/metrics/categories)