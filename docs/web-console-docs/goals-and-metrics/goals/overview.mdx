...
`goals` (like `Experiments`, `Features`, `Metrics` & `Templates`) are Managed-Assets and, as such, have a specific [ownership model](/docs/web-console-docs/ownership-and-permissions)
