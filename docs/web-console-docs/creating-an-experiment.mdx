...
Here, you can choose which type of analysis your experiment will use. A/B Smartly
...
<Image img="description.png" alt="A screenshot of the Description experiment creation page" />

## Description

The description step is where you can fill in details about your experiment 
...
your development [environments](/docs/Web%20Console%20Docs/settings#environments).
