...
:::warning
For an multi-variant experiment to be eligible for Group Sequential Testing, it requires an equal split between variants (exclusing base).
:::
...
[**Fixed Horizon setup guide**](/docs/web-console-docs/setting-up-a-fixed-horizon-experiement)
