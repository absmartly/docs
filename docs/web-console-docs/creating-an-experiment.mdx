...
You can learn more about experimentation metrics in our [Understanding Experimentation Metrics](/docs/web-console-docs/goals-and-metrics/metrics/understanding-experimentation-metrics) article.
### The Primary Metric
