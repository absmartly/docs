...
:::info
If you want to **export ALL the exposure and goal events for a single experiment**, you can do it directly from the experiment overview page by clicking on the ... menu and seleting **Export data**.
:::
