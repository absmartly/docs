...
The Explore tab is a powerful tool for debugging and inspecting individual goal and exposure events. 
To access it, select `Events` from the sidebar and click on the **Explore** tab.
...
[Exposure events](exposure-events) are sent by the SDKs when the `treatment` function is called. 
...
created and edited in the [Dashboard Settings](/docs/web-console-docs/configuration/settings).
...
[Dashboard Settings](/docs/web-console-docs/configuration/settings#environments). 
