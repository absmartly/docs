...
Before sending exposure events, make sure to correctly initialise and enrish the ABsmartly's context with the [visitor's identity](visitors-identity).
...
<Image
  img="events/events-page-exposure.png"
