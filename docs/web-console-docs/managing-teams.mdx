...
# Guide to creating and managing teams
...
INFO You must have the relevant permissions (`Team admin` or `Team create`) to create a team.
...
The left-hand panel shows the full **team hierarchy**:
