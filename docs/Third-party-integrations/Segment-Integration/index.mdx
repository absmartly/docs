...
You can [install a custom event logger](/docs/APIs-and-SDKs/SDK-Documentation/getting-started) in ABsmartly and send exposures directly to Segment.
...
<details>
  ...
  <div>
    ...
    [install a custom event logger](/docs/APIs-and-SDKs/SDK-Documentation/getting-started)
