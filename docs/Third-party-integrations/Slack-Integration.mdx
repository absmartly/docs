...
* Add your ABsmartly details to the integration:
    ...
    * Click the “Set user API key” button and enter your User API Key. If you do not yet have one, in the modal there will be a link to the page on your dashboard where one can be created — see [Personal API Keys](/docs/web-console-docs/users-teams-permissions/personal-api-keys) for the step-by-step flow.
