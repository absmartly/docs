...
:::caution
We recommend that you do not change the variables of your control variant.
:::
...
:::info
To use the `context.variableValue` method in a `useEffect` hook, you must
memo-ize the context in its initialization:
:::
