...
:::info
The following examples assume that an [Api Key with SDK permissions](/docs/Web%20Console%20Docs/settings#api-keys),
an [Application](/docs/Web%20Console%20Docs/tutorial#2-setting-your-applications), and an
[Environment](/docs/Web%20Console%20Docs/settings#environments) have been created in the A/B Smartly Web Console.
:::
