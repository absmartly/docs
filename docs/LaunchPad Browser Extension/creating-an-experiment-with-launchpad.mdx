...
<Image img="launchpad/create-metadata.png" alt="Experiment metadata" maxWidh="20rem" />
...
<Image img="launchpad/create-variants.png" alt="Experiment variants" maxWidh="20rem" />
...
<Image img="launchpad/create-url-targeting.png" alt="URL targeting" maxWidh="20rem" />
...
<Image img="launchpad/create-dom-changes.png" alt="DOM changes" maxWidh="20rem" />
...
<Image img="launchpad/create-visual-editor.png" alt="Visual Editor" maxWidh="60rem" />
