...
You can install the ABsmartly LaunchPad extension directly from the [Chrome Web Store](https://chromewebstore.google.com/detail/absmartly-launchpad/ccgdfdoliacjoippencomabalallheom).
