...
This section explains how to use the ABsmartly Web Console to run experiment and feature flags.
...
- using the LaunchPad browser extension  
...
You will find:
- SDK documentation for client side, server side and mobile  
- SDK API references and examples  
- The full platform API reference for programmatic access  
