...
import ReactSelectingAVariable from "!!raw-loader!./react/selectingAVariable.js";
...
<CodeBlock language="jsx">{ReactSelectingAVariable}</CodeBlock>

:::info
Variant variables cannot be obtained before the context is ready. In React, we
recommend that you put the above code into your useEffect. For example:
