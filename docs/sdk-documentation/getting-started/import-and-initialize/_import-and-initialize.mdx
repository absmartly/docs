...
| environment | `"production"` or `"development"` |  &#9989;  | `undefined` | The environment of your experiment. This is chosen on the web console.                        |
| application | `string`                          |  &#9989;  | `undefined` | The application on which your experiments will take place. This is chosen on the web console. |
