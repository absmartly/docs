...
The Vue SDKs wrap the JavaScript SDK. The context you access via `this.$absmartly` is
a standard JavaScript SDK context, so all the methods on this page work the same way.
Use the **Javascript** tab for code examples.
:::
