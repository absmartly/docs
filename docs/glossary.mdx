...
Example:
A company sets a non-binding futility boundary at the halfway point of an A/B test. 
The treatment effect is flat, but the team decides to continue because external factors suggest the impact may emerge later — a valid choice under the non-binding rule.
