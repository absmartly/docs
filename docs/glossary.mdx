...
-- Start with strong hypotheses grounded in user behavior, prior data, or product theory. Avoid “spaghetti testing” — randomly trying ideas just to see what sticks.
