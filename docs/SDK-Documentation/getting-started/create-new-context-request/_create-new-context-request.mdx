...
<CodeBlock language="python">{PythonSync}</CodeBlock>

#### Asynchronously

<CodeBlock language="python">{PythonAsync}</CodeBlock>

#### With Prefetched Data

<CodeBlock language="python">{PythonPreFetchedData}</CodeBlock>
...
<CodeBlock language="python">{PythonRefreshWithFreshData}</CodeBlock>

Alternatively, the `refresh()` method can be called manually.
The `refresh()` method pulls updated experiment data from the A/B Smartly 
collector and will trigger recently started experiments when `get_treatment()` 
is called.

<CodeBlock language="python">{PythonRefreshWithRefreshMethod}</CodeBlock>
...
<CodeBlock language="python">{PythonExtraUnits}</CodeBlock>
...
pulls updated experiment data from the A/B Smartly collector and will trigger
