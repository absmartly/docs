...
The Usage Report is enabled from **Platform Settings**. Keep in mind that turning it on enables the beta experience for **all users on your account** — it's not a per-user toggle. You can switch it off again at any time while we continue collecting feedback.
...
:::info Opt-in Beta
Enable the Metric Usage Report from **Platform Settings**. Once enabled it applies to everyone on the account, and can be turned off again at any time. We'd love your feedback — please reach out via your usual support channel or [drop us a line](mailto:support@absmartly.com).
:::
