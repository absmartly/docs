...
Experiments which already exceed a limit keep working. They can be started, stopped, restarted and edited, and the oversized field can be reduced, but it cannot grow any further. ABsmartly can adjust the limits for an account when required.
