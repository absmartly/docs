...
## Overview  
This release includes a number of small but meaningful improvements and bug fixes. While the team continues work on major backend updates coming soon, this update focuses on performance optimizations and fixes that improve clarity and usability.
...
- **Add to favorite fixed**: We fixed an issue where adding experiments to the list of favorites did not always work.
