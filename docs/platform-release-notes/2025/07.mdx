...
- **Team assignments**: Get notified when you're added/removed to a team  
...
We've added a new **Impact per Day estimates** on all relevant metric type inside the experiment overview to help you better understand the real-world significance of your experiment results.  
...
Let us know if you have any questions or if you would like to discuss future features with us.
